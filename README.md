...
* Once the users link to the [Friend Finder Home Page](https://the-friends-finder.herokuapp.com/)(note:since it is deployed on Heroku, please give it few seconds to load the page), it will show the *Go to Survey* buttom. Then the users can link to the survey page right away.

* After link to the [survey page](https://the-friends-finder.herokuapp.com/survey), it will ask the user to enter name and a link of their photo. Next, they will answer 10 questions based on the scale of 1 - 5 with how much the users agree or disagree with each question.
